...
import (
	...
	"github.com/oleoneto/go-toolkit/validator"
)
...
func Test_Validate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := validator.Validate(tt.model, tt.options); !reflect.DeepEqual(got, tt.want) {
...
func Test_ValidatePayload(t *testing.T) {
	...
	type args struct {
		data    []byte
		model   any
		options validator.PayloadValidationOptions
	}
			...
			args: args{
				...
				options: validator.PayloadValidationOptions{
					DecoderOptions: decoder.DecoderOptions{
						Rules: []decoder.SchemaValidationRule{
							decoder.ADDITIONAL_PROPERTY,
							decoder.INVALID_TYPE,
							decoder.REQUIRED_ATTRIBUTE,
						},
					},
				},
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := validator.ValidatePayload(tt.args.data, tt.args.model, tt.args.options); !reflect.DeepEqual(got, tt.want) {
...
func Test_IsIn(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := validator.IsIn(tt.args.value, tt.args.acceptedValues); got != tt.want {
...
func Test_IsUUID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := validator.IsUUID(tt.arg); got != tt.want {
